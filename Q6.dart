...
void main() {
  Map<String, Map<String, String>> world = {
    "Pakistan": {"Capital City": "Islamabad","Currency": "Rupees","Language": "Urdu"},
    "India": {"Capital City": "Mumbai","Currency": "Rupia","Language": "Hindi"},
    "Bangladesh": {"Capital City": "Dhaka","Currency": "Taka","Language": "Bangali"},
  };
print(world["India"]);
}